...
class PageControlRecyclerViewAdapter(context: Context, activity: Activity, timelineList: ArrayList<TimelinePlanData>) : RecyclerView.Adapter<PageControlRecyclerViewAdapter.ViewHolder>() {
    ...
    // [5]
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PageControlRecyclerViewAdapter.ViewHolder {
